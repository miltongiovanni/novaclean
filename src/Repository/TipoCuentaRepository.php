...
/**
 * @extends ServiceEntityRepository<TipoCuenta>
 *
...
class TipoCuentaRepository extends ServiceEntityRepository
{
    ...
    public function save(TipoCuenta $entity, bool $flush = false): void
    {
    ...
    public function remove(TipoCuenta $entity, bool $flush = false): void
    {
