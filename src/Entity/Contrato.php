...
class Contrato
{
    ...
    public function toArray()
    {
        return [
            ...
            'f_inicio' => $this->getFInicio()->format('Y-m-d'),
            'f_fin' => $this->getFFin()->format('Y-m-d'),
            ...
            'vencimiento_poliza' => $this->getVencimientoPoliza() ? $this->getVencimientoPoliza()->format('Y-m-d') : null,
